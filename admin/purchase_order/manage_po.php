...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h4 class="card-title"><?php echo isset($id) ? "Purchase Order Details - ".$po_code : 'Créer une nouvelle commande en cours' ?></h4>
    </div>
    <div class="card-body">
        <form action="" id="po-form">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6">
                        <label class="control-label text-info">Code Fournisseur</label>
                ...
                <hr>
                <fieldset>
                    <legend class="text-info">Details commande</legend>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="remarks" class="text-info control-label">Commentaire</label>
        ...
        $('#supplier_id').change(function(){
            ...
            if(!!items[supplier_id]){
                ...
                list_item.then(function(){
                    $('#item_id').select2({
                        placeholder:"Séléctionner un article",
                        width:'resolve',
                    })
                })
            }else{
                list_item.then(function(){
                    $('#item_id').select2({
                        placeholder:"Pas d'articles sélectionner encore",
                        width:'resolve',
                    })
                })
            }
