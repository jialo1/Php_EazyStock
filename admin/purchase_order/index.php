<!-- Translation Code here -->
	...
	<div class="card-header">
        ...
        <div class="card-tools">
			<a href="<?php echo base_url ?>admin/?page=purchase_order/manage_po" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span> Créer une nouvelle commande</a>
		</div>
	</div>
	<div class="card-body">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <?php elseif($row['status'] == 1): ?>
                                        <span class="badge badge-warning rounded-pill">Reçu en partie</span>
